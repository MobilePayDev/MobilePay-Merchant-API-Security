...
8.	After you have generated the encrypted file (.enc ending) you need to send it to mp_appswitch@mobilepay.dk. In the email please add your Merchant Id (APP(DK/NO/FI)XXXXXXXXXX) and your AppSwitch primary subscription key.
