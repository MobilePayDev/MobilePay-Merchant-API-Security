...
8.	Send your public key certificate in a txt-file to developer@mobilepay.dk since a crt-file can be rejected by the mailserver. Please include your MobilePay API e-mail, merchant id (APP(DK/FI)XXXXXXXXXX), AppSwitch primary subscription key and your own certificate's expiration date*.
